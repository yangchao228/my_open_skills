...
if [ ! -f "$release_plan_file" ]; then
  ...
  [ "$medium_gate" = "submitted" ] || error "$release_plan_file medium-risk gate must be submitted"
  [ "$high_gate" = "submitted" ] || error "$release_plan_file high-risk gate must be submitted"
